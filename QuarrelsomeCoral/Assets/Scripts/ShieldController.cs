...
public class ShieldController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (ShieldManager.GetShieldManagerInstance().m_PlayerControlled)
        {
            m_MovementInput = Input.GetAxisRaw(ShieldManager.GetShieldManagerInstance().m_PlayerControlScheme);
            ...
            m_NewPosition = new Vector3(m_XAxisRadius * Mathf.Cos(m_MoveAmount * m_Speed), m_YAxisRadius * Mathf.Sin(m_MoveAmount * m_Speed), 1);
